...
(function ($) {
    ...
    $.skdslider.enableTouch = function (element, slides, config) {
        element[0].addEventListener('touchstart', onTouchStart, true);
        var startX;
        var startY;
        var dx;
        var dy;
        ...
        function onTouchStart(e) {
            ...
            element[0].addEventListener('touchmove', onTouchMove, true);
            element[0].addEventListener('touchend', onTouchEnd, true);
        }
     ...
     /*   function onTouchMove(e) {
        ...
        function onTouchEnd(e) {
            element[0].removeEventListener('touchmove', onTouchMove, true);
            if (dx > 0) {
                $.skdslider.next(element, slides, config);
            } else {
                $.skdslider.prev(element, slides, config);
            }
            element[0].removeEventListener('touchend', onTouchEnd, true);
        }
      */
    }
